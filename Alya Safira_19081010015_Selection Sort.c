...
// Memilih Proses yang di inginkan 
		...
		printf("4. MENGURUTKAN DATA USIA MAHASISWA DENGAN BUBBLE SORT\n");
		printf("5. MENGURUTKAN DATA USIA MAHASISWA DENGAN SELECTION SORT\n");
		printf("---------------------------------------------------------\n");
		...
		if(pilihan==1)
{
	...
	else if (pilihan==2)
	{
		...
		{
				int pilihan,b,c;
				printf("PROSES PEMILIHAN METODE SORTING USIA :\n");
				printf("---------------------------------\n");
				printf("1. METODE BUBBLE SORT ASCENDING \n");
				printf("2. METODE BUBBLE SORT DESCENDING\n");
				printf("---------------------------------\n");
			...
			if (pilihan==1)
				...
				printf("Menampilkan Data Lengkap Mahasiswa Yang Telah Diurutkan Berdasarkan Usia Yang Paling Muda\n\n");
				...
				printf("\t\t--PROGRAM BUBBLE SHORT USIA MAHASISWA ASCENDING --\n\n");
				printf("Data Usia Sebelum Dirutkan \t:\n\n");
				...
				printf("Menampilkan Data Lengkap Mahasiswa Yang Telah Diurutkan Berdasarkan Usia Dari Yang Paling Tua\n\n");
				printf("_________________________________________________________________________________________________________________\n\n"); 	
				printf("\n\n------ Mahasiswa Absen 2 ------\n\n");
				printf("Nama        = Nadia Rahma\n\n");
				printf("Usia        = 20 tahun\n\n");
				...
				printf("\t\t--PROGRAM BUBBLE SHORT USIA MAHASISWA DESCENDING --\n\n");
				printf("Data Usia Sebelum Dirutkan \t:\n\n");
				...
				printf("Data Terurut Dari Yang Paling Tua\t:\n\n");
				for(i=0;i<n;i++)
				printf("%4i",A[i]);
				printf("\n\nJumlah data\t: %d\n",n);
				printf("\n\n");
		...
		{   	int pilihan,b,c;
				printf("PROSES PEMILIHAN METODE SORTING USIA :\n");
				printf("---------------------------------\n");
				printf("1. METODE SELECTION SORT ASCENDING \n");
				printf("2. METODE SELECTION SORT DESCENDING\n");
				printf("---------------------------------\n");
				printf("Masukkan pilihan anda [1..2] : ");
				scanf("%i",&pilihan);
				printf("\n");
			...
			if(pilihan==1)
{
				...
				printf("\t\t--PROGRAM SELECTION SHORT USIA MAHASISWA ASCENDING --\n\n");
				printf("Data Usia Sebelum Dirutkan \t:\n\n");
				...
				printf("\t\t--PROGRAM SELECTION SHORT USIA MAHASISWA DESCENDING --\n\n");
				printf("Data Usia Sebelum Dirutkan \t:\n\n");
